...
func Projects(contributions []models.ContributionDay) templ.Component {
...
func Partial(contributions []models.ContributionDay) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div id=\"fishtank-container\" class=\"m-5 w-full md:w-1/2 h-120 md:h-auto\"><h2 class=\"font-black text-orange-400 text-center justify-center mb-0\">My Fish Tank</h2><canvas id=\"fishtank\" class=\"w-full h-full border-4 border-orange-400 rounded-lg\"></canvas></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func contributionDay(day models.ContributionDay) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/projects/projects.templ`, Line: 442, Col: 74}
		}
